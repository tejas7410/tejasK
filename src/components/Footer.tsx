...
const Footer: React.FC = () => {
  return (
    <footer className="py-8 text-black dark:text-white bg-white dark:bg-gray-900 border-t-4 border-gray-200 dark:border-gray-800 stick bottom-0">
      <div className="md:px-8 container px-4 mx-auto">
        <div className="md:flex-row flex flex-col items-center justify-between">
          ...
          <div className="flex items-center gap-4">
              ...
              <SocialIcon url='mailto:kanguletejas322@gmail.com' />
          </div>
        </div>
